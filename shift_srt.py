...
if len(sys.argv) != 4:
    print("Uso: python shift_srt.py entrada.srt saida.srt deslocamento_em_segundos")
    print("Exemplo: python shift_srt.py legenda.srt legenda_corrigida.srt -95")
    sys.exit(1)

infile, outfile, shift_str = sys.argv[1], sys.argv[2], sys.argv[3]
